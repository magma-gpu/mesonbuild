...
def run_compiler_checks(cross_file):
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print("Hi, it's me, I'm the problem it seems")
        mlog.log('compiler id:', cc.get_id())
        mlog.log('C compiler id:', cc.get_id())
        mlog.log('C++ compiler id:', cpp.get_id())
...
def main():
    ...
    run_compiler_checks(args.cross_file)
